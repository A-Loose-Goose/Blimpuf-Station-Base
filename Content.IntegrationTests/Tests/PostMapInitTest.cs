...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest : GameTest
    {
        ...
        private static readonly Dictionary<string, HashSet<EntProtoId>> DoNotMapWhitelistSpecific = new()
        {
            ...
            {"/Maps/_Starlight/Centcomms/CC_Outpost_GNT9.yml", ["BoxFolderCentCom", "RubberStampCAD", "RubberStampCCD", "RubberStampCDD", "RubberStampCED", "RubberStampCentcom", "RubberStampCMD", "RubberStampCRD", "RubberStampCSD"]}// Starlight end
        };
